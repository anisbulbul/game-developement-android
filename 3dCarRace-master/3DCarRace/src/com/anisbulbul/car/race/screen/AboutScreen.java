...
public class AboutScreen extends GameAssets implements Screen, InputProcessor {
	...
	public AboutScreen(CarRace3D game, ActionResolver actionResolver) {
	...
	private void loadComponents() {
		...
		aboutBackgroundTexture = initTexture("data/aboutbackground.png");

		aboutMusic = initMusic("sounds/about_music.mp3");
	}
	...
	public void dispose() {
		...
		spriteBatch.dispose();
		font.dispose();
		aboutBackgroundTexture.dispose();
