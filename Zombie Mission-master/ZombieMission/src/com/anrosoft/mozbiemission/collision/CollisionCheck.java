package com.anrosoft.mozbiemission.collision;
...
public class CollisionCheck {
	...
	public static boolean isCollisionOccuredRectaPoint2x2(float x1, float y1,
		...
		return isCollisionOccuredRectaPoint2x2SubDivision(x1, y1, x2, y2, x3,
				y3, x4, y4)
				|| isCollisionOccuredRectaPoint2x2SubDivision(x3, y3, x4, y4,
						x1, y1, x2, y2) 
				|| isCollisionOccuredRectaPoint2x1(x1, y1, x2, y2,
								(x3+x4)/2, y3)
				|| isCollisionOccuredRectaPoint2x1(x1, y1, x2, y2,
								(x3+x4)/2, y4)
				|| isCollisionOccuredRectaPoint2x1(x1, y1, x2, y2,
	...
	public static boolean isCollisionOccuredRectaPoint2x2SubDivision(float x1,
