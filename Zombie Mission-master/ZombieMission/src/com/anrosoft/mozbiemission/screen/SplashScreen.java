...
import com.anrosoft.mozbiemission.tween.SpriteAccessor;
...
public class SplashScreen extends GameAssets implements Screen {
	...
	public SplashScreen(ZombieMission game) {
		this.game = game;
		this.splashScreenTexture = initTexture("backgrounds/splash.png");
	}
