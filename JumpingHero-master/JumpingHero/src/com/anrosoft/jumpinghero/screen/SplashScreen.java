...
import com.anrosoft.jumpinghero.tween.SpriteAccessor;
...
public class SplashScreen extends GameAssets implements Screen {
	...
	public SplashScreen(JumpingHero game) {
		this.game = game;
		this.splashScreenTexture = initTexture("background_screens/splash.png");
	}
