package com.anrosoft.jetadventure.files;
...
public class FileHandlers extends GameAssets{
	...
	public static boolean setGameData() {
		...
		if (!Gdx.files.local("jetadventure_status.ini").exists()) {
			initFiles();
		}

		FileHandle handleTemp = Gdx.files.local("jetadventure_status.ini");
	...
	public static void initGameData() {
		...
		FileHandle handle = Gdx.files.local("jetadventure_status.ini");
		if (handle.exists()) {
	...
	private static void initFiles() {
		...
		Gdx.files.internal("file/jetadventure_status.ini").copyTo(
				Gdx.files.local("jetadventure_status.ini"));
